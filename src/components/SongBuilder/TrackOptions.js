      ...
      <PopupMenu.Popup>
        <Menu x={-38} y={-9}>
          ...
          <MenuOptions>
            <span
              onClick={() => {
                tracks.updateTrack(props.trackIndex, { trackType: 'recording' })
                popups.closePopup()
              }}
            >
            ...
            <span
              onClick={() => {
                tracks.updateTrack(props.trackIndex, { trackType: 'audio' })
                popups.closePopup()
              }}
            >
            ...
            <span
              onClick={() => {
                tracks.updateTrack(props.trackIndex, { trackType: 'midi' })
                popups.closePopup()
              }}
            >
            ...
            <span
              onClick={() => {
                tracks.updateTrack(props.trackIndex, { trackType: 'plugin' })
                popups.closePopup()
              }}
            >
            ...
            <span
              onClick={() => {
                tracks.updateTrack(props.trackIndex, { trackType: 'text' })
                popups.closePopup()
              }}
            >
            ...
            <span
              onClick={() => {
                tracks.removeTrack(props.trackIndex)
                popups.closePopup()
              }}
            >
