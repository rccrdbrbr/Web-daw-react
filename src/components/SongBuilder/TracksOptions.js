...
export const TracksOptions = (props) => {
  ...
  return (
    <StyledContainer>
      ...
      <StyledActionIcon onClick={tracks.addRecordingTrack} title="Add Recording Track">
        <Icon name="microphone" />
      </StyledActionIcon>
      <StyledActionIcon onClick={tracks.addAudioTrack} title="Add Audio Track">
        <Icon name="paperclip" />
      </StyledActionIcon>
      <StyledActionIcon onClick={tracks.addMidiTrack} title="Add MIDI Track">
        <Icon name="table" />
      </StyledActionIcon>
      <StyledActionIcon onClick={tracks.addPluginTrack} title="Add Plugin Track">
        <Icon name="plug" />
      </StyledActionIcon>
      <StyledActionIcon onClick={tracks.addTextTrack} title="Add Notes/Lyrics Track">
        <Icon name="pen" />
      </StyledActionIcon>
    </StyledContainer>
  )
